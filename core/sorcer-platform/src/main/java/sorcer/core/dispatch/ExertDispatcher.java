...
abstract public class ExertDispatcher implements Dispatcher {
    ...
    // make sure subject is setValue before and after any object goes out and comes
    // in dispatcher.
    ...
    protected void collectOutputs(Mogram mo) throws ContextException {
        ...
        } else if (mo instanceof ContextModel) {
            try {
                sharedContexts.add((Context) ((ContextModel)mo).getResponse());

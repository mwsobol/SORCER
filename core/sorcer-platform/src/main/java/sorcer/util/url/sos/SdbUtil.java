...
public class SdbUtil {
	...
	static public Context getStoreContext(Object object)
		...
		cxt.setContextReturn(StorageManagement.object_url);
		return cxt;
	}
	...
	static public Context getRetrieveContext(Uuid uuid, Store type)
		...
		cxt.setContextReturn(StorageManagement.object_retrieved);
		return cxt;
	}
	...
	static public Context getListContext(Store storeType)
		...
		cxt.setContextReturn(StorageManagement.store_content_list);
		return cxt;
	}

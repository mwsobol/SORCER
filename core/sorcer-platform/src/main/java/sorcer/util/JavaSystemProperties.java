...
public class JavaSystemProperties {
     ...
     * @param key             property key
     * @param defaultValue    default eval returned if property is not defined
     * @param properties      properties to search they key in. If null, the system properties are used
     * @return property eval or default eval if the property is not defined
     */

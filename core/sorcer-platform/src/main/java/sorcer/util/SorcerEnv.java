 ...
 * directory (sorcer/util/sorcer.env), or in the contextReturn given by the JVM system
...
public class SorcerEnv extends SOS {
	 ...
	 * 
	 * @return a contextReturn of the home directory
	 */
	...
	protected static void loadEnvironment() throws ConfigurationException {
		// Try and load from contextReturn given in system properties

...
public interface Context<T> extends Model, Mappable<T>, Serializable, Evaluation<T>,
		Invocation<T>, Dependency, Contexter<T>, Identifiable, Paradigmatic, Arg, Service {

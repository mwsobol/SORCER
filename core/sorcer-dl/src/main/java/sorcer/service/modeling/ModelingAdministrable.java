...
/** 
 * Every administered model service should implement this interface. 
 *
 * @author Mike Sobolewski
 */
public interface ModelingAdministrable {
    /**
     * Returns an object that implements whatever administration interfaces
     * are appropriate for the particular model.
     *
     * @return an object that implements whatever administration interfaces
     *         are appropriate for the particular model.
     * @throws java.rmi.RemoteException
     */
    Object getModelAdmin() throws java.rmi.RemoteException;
}

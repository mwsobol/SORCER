...
public interface Functionality<T> extends Identifiable, ent<T> {
	 ...
	 */
	public enum Type {
		INPUT, CONSTANT, DOMAIN_CONSTANT, INVARIANT, OUTPUT, INOUT, RESPONSE, DESIGN, INITIAL_DESIGN, PARAMETER, LINKED,
		CONSTRAINT, OBJECTIVE, DERIVATIVE, GRADIENT, RANDOM, BOUNDED, FUNDAMENTAL, RAW, DELEGATION, COMPOSITION, MULTIVAL,
		DOMAIN, PRED, DOMAIN_PRED, FILTER, PERSISTER, EVALUATOR, EVALUATION, PRODUCT, WATCHABLE, ENT, PROC, NEURON, VAR,
		SRV, LAMBDA, VAL, THRESHOLD, BIAS, FUNCTION, DATA, CONTEXT, ARRAY, LIST, MODEL, EXERTION, MOGRAM, SELF, CONDITION,
		FIDELITY, LOCATOR, ARG, PATH, CONFIG, PROXY, COUPLED, MDA, MADO, OBJECTIVE_GRADIENT, CONSTRAINT_GRADIENT, NONE,

...
public interface Functionality<T> extends Identifiable, ent<T> {
	...
	public enum Type {
		...
		MULTIVAL, DOMAIN, PRED, DOMAIN_PRED, FILTER, PERSISTER, EVALUATOR, EVALUATION, PRODUCT, WATCHABLE, ENT, PROC,
		NEURON, VAR, SRV, LAMBDA, VAL, THRESHOLD, BIAS, FUNCTION, DATA, CONTEXT, ARRAY, LIST, MODEL, EXERTION, MOGRAM,
		SELF, CONDITION, FIDELITY, LOCATOR, ARG, PATH, CONFIG, PROXY, COUPLED, MDA, MADO, OBJECTIVE_GRADIENT,

...
public interface ParametricModelingAdmin extends ModelingAdmin {

	public ModelTable getParametricTable() throws RemoteException;

	public ModelTable getResponseTable() throws RemoteException;

	public void initilizeModel() throws RemoteException, EvaluationException;
	
	public String describeStrategy() throws RemoteException;

...
public interface Variability<T> extends Identifiable, Evaluation<T>, Setter, Perturbation<T>, Serializable {
	...
	public enum Type {
		...
		DERIVATIVE, GRADIENT, RANDOM, BOUNDED, FUNDMENTAL, RAW, DELEGATION, COMPOSITION, MULTIVAL,
		FILTER, PERSISTER, EVALUATOR, EVALUATION, PRODUCT, WATCHABLE, ENT, PROC, VAR, SRV, LAMBDA, VAL,
		DATA, CONTEXT, ARRAY, LIST, MODEL, EXERTION, SELF, FIDELITY, LOCATOR, ARG, PATH, CONFIG, SHARED, EVALUATED, NONE
	}

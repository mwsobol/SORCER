...
public interface Variability<T> extends Identifiable, Evaluation<T>, Setter, Perturbation<T>, Serializable {
	 ...
	 */
	public enum Type {
		INPUT, CONSTANT, DOMAIN_CONSTANT, INVARIANT, OUTPUT, INOUT, RESPONSE, DESIGN, PARAMETER, LINKED,
		CONSTRAINT, GRADIENT, CONSTRAINT_GRADIENT, OBJECTIVE, OBJECTIVE_GRADIENT, COUPLED, MDA, MADO,
		DERIVATIVE, RANDOM, BOUNDED, FUNDAMENTAL, RAW, DELEGATION, COMPOSITION, MULTIVAL, DOMAIN, PRED, DOMAIN_PRED,
		FILTER, PERSISTER, EVALUATOR, EVALUATION, PRODUCT, WATCHABLE, ENT, PROC, NEURON, VAR, SRV, LAMBDA, VAL,
		THRESHOLD, BIAS, DATA, CONTEXT, ARRAY, LIST, MODEL, EXERTION, SELF, CONDITION, FIDELITY, LOCATOR, ARG,
		PATH, CONFIG, PROXY, NONE
	}

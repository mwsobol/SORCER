...
public class SpaceCmd extends ShellCmd {

	{
		...
		COMMAND_HELP = "Support for exertion spaces; 'space' mode"
				...
				+ "\n  -a   show all space exertions, set the 'exertion' mode"
				+ "\n  -d   show done space exertions, set the 'exertion' mode"
				+ "\n  -f   show failed space exertions, set the 'exertion' mode"
				...
				+ "\n  -ta   take all exertions from the Space"

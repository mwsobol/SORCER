...
public class CoffeemakerClient {
	...
	public static void addRecipe() {
	    ...
	    //Read in amt coffee
	    String coffeeString = inputOutput("\nPlease execEnt the units of coffee in the recipe: ");
	    ...
	    //Read in amt milk
	    String milkString = inputOutput("\nPlease execEnt the units of milk in the recipe: ");
	    ...
	    //Read in amt sugar
	    String sugarString = inputOutput("\nPlease execEnt the units of sugar in the recipe: ");
	    ...
	    String chocolateString = inputOutput("\nPlease execEnt the units of chocolate in the recipe: ");
    ...
    public static void addInventory() {
	    //Read in amt coffee
	    String coffeeString = inputOutput("\nPlease execEnt the units of coffee to add: ");
	    int amtCoffee = stringToInt(coffeeString);
	    if(amtCoffee < 0) {
	    ...
	    //Read in amt milk
	    String milkString = inputOutput("\nPlease execEnt the units of milk to add: ");
	    int amtMilk = stringToInt(milkString);
	    if(amtMilk < 0) {
	    ...
	    //Read in amt sugar
	    String sugarString = inputOutput("\nPlease execEnt the units of sugar to add: ");
	    int amtSugar = stringToInt(sugarString);
	    if(amtSugar < 0) {
	    ...
	    //Read in amt chocolate
	    String chocolateString = inputOutput("\nPlease execEnt the units of chocolate to add: ");
	    int amtChocolate = stringToInt(chocolateString);
	    if(amtChocolate < 0) {
    ...
    public static void makeCoffee() {
        ...
        String amountPaid = inputOutput("Please execEnt the amount you wish to pay");

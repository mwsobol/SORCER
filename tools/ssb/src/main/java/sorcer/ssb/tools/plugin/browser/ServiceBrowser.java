...
public class ServiceBrowser {
	...
	private static String STATE = ".ssb.state";
	...
	private static Configuration getConfiguration() {
		return ServiceBrowserConfig.getConfiguration();
	}

	private static void setConfiguration(Configuration configuration) {
		ServiceBrowserConfig.setConfiguration(configuration);
	}
	...
	public static void start(String[] args, boolean pluginStart,
		...
		try {
			...
			try {
				...
				System.err
						.println("Unable to determine requestPath, using working directory");
			}
			ImageIcon logo = null;
			// BRANDING
